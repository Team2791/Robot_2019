...
public class Constants {
	...
	public static final double kRaiseCargoArmsDelayAfterButtonPressed = 0.33; //This is the delay between when the ball presses the switch on the intake and when the intake is raised
